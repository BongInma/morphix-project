...
const TAB_CONTENT: Record<string, {
  ...
  residency: {
    ...
    body: "To resolve critical data sovereignty barriers across the Asia-Pacific corridor, OmniDiff enforces hardware-level geographical geofencing at the orchestration layer. Compute tasks are cryptographically tagged with their geographic assignment at ingestion and are strictly routed to verified provider nodes residing within your specified national jurisdiction. This prevents cross-border data leakage and satisfies localized data-residency mandates, enabling public sector entities and regulated financial institutions to leverage optimized edge computing without regulatory exposure.",
          ...
          <div className="flex-1 overflow-y-auto p-8 bg-surface">
            {content && (
              <div>
                ...
                <p className="font-[family-name:var(--font-inter)] text-sm text-text-muted leading-relaxed max-w-prose">
                  {content.body}
                </p>
