    ...
    <header className="sticky top-0 z-50 border-b border-[#1F2937] bg-[#0B0C0E]/90 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
        <div className="flex flex-col leading-none">
          ...
          <span className="text-[#4B5563] text-[9px] sm:text-[10px] tracking-[0.08em] sm:tracking-[0.15em]" style={{ fontFamily: "'Inter', sans-serif", WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale", textTransform: "none", letterSpacing: "0.12em" }}>
...
export default function OmniDiff() {
  ...
  return (
    <div className="min-h-screen overflow-y-auto scroll-smooth text-white" style={{ backgroundColor: "#0B0C0E", fontFamily: "'Inter', sans-serif", scrollPaddingTop: "4rem" }}>
      ...
      <footer style={{ width: "100%", maxWidth: "1200px", margin: "4rem auto 2rem auto", padding: "2rem 1rem", textAlign: "center", borderTop: "1px solid rgba(255, 255, 255, 0.1)", color: "rgba(255, 255, 255, 0.4)", fontSize: "0.75rem", lineHeight: "1.4" }}>
