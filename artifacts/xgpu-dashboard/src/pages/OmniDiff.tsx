    ...
    <header className="sticky top-0 z-50 border-b border-[#1F2937] bg-[#0B0C0E]/90 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
        <div className="flex flex-col leading-none">
          ...
          <span className="text-[#4B5563] text-[9px] sm:text-[10px] tracking-[0.08em] sm:tracking-[0.15em] uppercase" style={{ fontFamily: "'Inter', sans-serif", WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}>
