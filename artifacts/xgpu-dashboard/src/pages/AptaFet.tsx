...
export default function AptaFet() {
  return (
    <div className="min-h-screen bg-background text-white pl-[260px]">
      <div className="mx-auto max-w-4xl px-8 py-10">
        ...
        <div className="mt-8 rounded-3xl border border-white/10 bg-white/[0.05] p-8 backdrop-blur-xl">
          <h1 className="text-3xl font-semibold">Morphix AptaFet</h1>
          <p className="mt-3 text-sm text-muted-foreground">Metabolic Intelligence Sync. Status: Pending hardware integration Q4 2026.</p>
        </div>
      </div>
    </div>
  );
